...
;(function($){
	$.contextMenu = {
      ...
      obj.$element = $div;
        ...
        var item=cmenu.items[i];
        for (var opt in item) {
          var option = item[opt];
          var beforeShow = option.beforeShow;
          if (beforeShow) {
            beforeShow.call(cmenu.target,option);
          }
        }
      }
		},
	...
	$.fn.contextMenu = function(menu,context,options) {
		var cmenu = $.contextMenu.create(menu,options);
		return this.each(function(){
      if(context) {
        $(this).on('contextmenu',context,function(e){cmenu.show(this,e);return false;});
      } else {
